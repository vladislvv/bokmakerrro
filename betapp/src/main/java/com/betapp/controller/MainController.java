...
public class MainController {
    ...
    // Обновляем баланс при возвращении на главную
    ...
    // Метод для симуляции всех матчей
    private void simulateAllMatches() {
        // Для простоты используем существующие DAO классы
        ...
        if (confirmAlert.showAndWait().orElse(javafx.scene.control.ButtonType.CANCEL) == javafx.scene.control.ButtonType.OK) {
            ...
            // Обновляем баланс пользователя (перезагружаем из БД)
            if (currentUser != null) {
